...
public class Decryptor {
    ...
    public static void main(String[] args) {
        ...
        shift = getShiftFromUser("Введите ключ дешифрования (число, должен совпадать): ");
        if (shift == Integer.MIN_VALUE) {
            System.err.println("Не удалось получить корректный ключ. Завершение программы.");
            return;
        }
        try {
            String encryptedText = readFile(inputFile);
            System.out.println("Читаем из " + inputFile + "...");
            String decryptedText = decrypt(encryptedText, shift);
            System.out.println("Дешифрование выполнено.");
            System.out.println("------------------------------------");
